...
max_total_ctx = 3000
llm = Llama(model_path="./models/wizardLM-7B.GGML.q4_2.bin", n_ctx=max_total_ctx)
...
def generate_response(chat, ltm): 
    ...
    Context "You are in a Discord server. Prioritize humor in your response, you like modern and dark humor. Directly address recent messages, and do NOT repeat your messages. Above all, be funny.
    Long-Term-Memory: "{ltm}"
